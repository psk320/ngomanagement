...
<div class="header">
	 <div class="container">
		 <div class="header-top">
			 <div class="logo">
				 <a href="homepage.jsp"><h1>Little <span>Homes</span></h1></a>
			 </div>
			 <div class="hdr-address">
				 <div class="address1">
					 <h5> ognizant CDC Phase 3C</h5>
		 ...
		 <div class="top-menu">
			 ...
			 <li class="active"><a href="about.jsp"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>About</a></li>
			 <li><a href="shortcodes.jsp"><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>Shortcodes</a></li>
			 <li><a href="gallery.jsp"><span class="glyphicon glyphicon-picture" aria-hidden="true"></span>Gallery</a></li>
			<li><a href="event.jsp"><span class="glyphicon glyphicon-time" aria-hidden="true"></span>Events</a></li>
 			 
			 <li><a href="contact.jsp"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span>Contact</a></li>1
	 ...
	 <div class="container">
		 ...
		 <div class="about-grids">
			 <div class="col-md-6 about-info">
				 ...
				 <h5>We support over 50,000 Non-Governmental Organizations with software training and technial support.</h5>
				 <p>We provide our software at virtually no cost to them , and they are lighting up the world with what they do.If we all act together - business , governments , 
                                ngo's and citizens and especially the youngs - just imagine the good we can create.</p>
			 </div>
		 ...
		 <div class="charitys abt-chrits">
			  <div class="col-md-4 chrt_grid" style="visibility: visible; -webkit-animation-delay: 0.4s;">
				   <div class="chrty">
						...
						<p>Child protection is the protection of children from violence, exploitation, abuse and neglect. 
						  </p>
			  ...
			  <div class="col-md-4 chrt_grid" style="visibility: visible; -webkit-animation-delay: 0.4s;">
				   <div class="chrty">
						...
						<p>Adoption procedures relate to social and legal matters. As a first step, 
							personnel of a recognized agency may be contacted for exchange of information and guidance.
							</p>
				   </div>
			  </div>
			  <div class="col-md-4 chrt_grid" style="visibility: visible; -webkit-animation-delay: 0.4s;">
				   <div class="chrty">
						...
						<p>Charitable giving is the act of giving money, goods or time to the unfortunate, 
							either directly or by means of a charitable trust or other worthy cause</p>  </div>
			  </div>
			  <div class="clearfix"></div>
		 </div>
